...
# repo-root .env — resolved from this file's location so it's found regardless
# of the invoking process's cwd (Makefile targets run from both repo root and backend/).
